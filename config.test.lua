-- Test-server client config. Shipped as config.lua by:
--   .\tools\make_release.ps1 -ConfigFile config.test.lua -Encrypt
--
...
-- Base host for the Koliseu TEST web API (login + account pages + status + crash).
local HOST = "https://gameteste.koliseuot.com.br"
