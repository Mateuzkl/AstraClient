locale = {
  ...
  translation = {
    ...
    "Wenn du das Programm schlie�t kann es sein, dass dein Charakter im Spiel verweilt.nKlicke 'Logout' um sicherzustellen, dass dein Charakter das Spiel wirklich verl�sst.\nKlicke 'Exit' wenn du das Programm beenden willst on deinen Charakter auszuloggen.",
    ["Ignore"] = false,
    ...
    "Vergewissere dich, dass der Client das richtige Protokoll verwendet.",
    ["Mana"] = "Mana",
    ...
    "Du musst eine g�ltige Serveradresse und einen g�ltigen Port eingeben",
