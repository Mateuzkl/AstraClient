...
locale = {
  ...
  translation = {
    ...
    "4b) Pretender tener influencia en una parte del reglamento",
    ...
    "Conocido por la comunidad de Koliseu como dash.\nRecomenada para jugadores de alto nivel.",
    ...
    "Ingresar la siguiente vez que aparece el charlist con el personaje seleccionado",
    ...
    "Mostrar velocidad de conexi�n en el servidor (millisegundos)",
    ...
    "Ingrese con su cuenta nuevamente para actualizar el cliente.",
    ["Error"] = "Error",
    ["Error"] = "Error",
    ...
    "Aseg�rese de que el cliente este utilizando\nes el versi�n del protocolo adecuado",
    ["Mana"] = "Mana",
    ...
    "Abrir lista de jugadores autom�ticamente al iniciar el cliente",
    ...
    "No se puede cargar el archivo dat, por favor coloque un dat v�lido en '%s'",
    ["Unable to load spr file, please place a valid spr in '%s'"] =
    "No se puede cargar el archivo spr, por favor coloque un spr v�lido en '%s'",
    ...
    "Detectara cuando se camina en diagonal usando las flechas",
