...
function registerProtocol()
  ...
  -- Inspection (0x76) is parsed by the C++ ProtocolGame::parseItemDetail, which fires
  -- g_game.onInspection (see mods/game_inspect). A Lua handler here would shadow the
  -- C++ parser (onOpcode runs first) and silently consume the packet, so it stays out.
