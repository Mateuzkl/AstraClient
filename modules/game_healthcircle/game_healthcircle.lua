...
function addToOptionsModule()
    if not modules.client_options or not modules.client_options.getPanel or not modules.client_options.addButton then
        return
    end
...
function destroyOptionsModule()
    if not modules.client_options or not modules.client_options.removeButton then
        return
    end
