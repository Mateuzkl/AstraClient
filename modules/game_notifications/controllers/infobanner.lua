...
function notificationsController:onClientEvent(eventCat, ...)
    local showInfoBanner = true
    if modules.client_options and modules.client_options.getOption then
        showInfoBanner = modules.client_options.getOption("showInfoBanner") ~= false
    elseif Options and Options.getOption then
        showInfoBanner = Options.getOption("showInfoBanner") ~= false
    end
