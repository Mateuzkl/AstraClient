...
void Proxy::check(const asio::error_code& ec)
{
    if (ec || m_terminated) {
        return;
    }
...
void Proxy::onHeader(const asio::error_code& ec, std::size_t bytes_transferred)
{
...
void Proxy::onPacket(const asio::error_code& ec, std::size_t bytes_transferred)
{
...
void Proxy::onSent(const asio::error_code& ec, std::size_t bytes_transferred)
{
    if (ec) {
#ifdef PROXY_DEBUG
...
void Session::terminate(asio::error_code ec)
{
    if (m_terminated)
        return;
    m_terminated = true;
...
void Session::check(const asio::error_code& ec)
{
    if (ec || m_terminated) {
        return;
    }
...
void Session::onHeader(const asio::error_code& ec, std::size_t bytes_transferred)
{
    if (ec) {
#ifdef PROXY_DEBUG
...
void Session::onBody(const asio::error_code& ec, std::size_t bytes_transferred)
{
    if (ec) {
#ifdef PROXY_DEBUG
...
void Session::onSent(const asio::error_code& ec, std::size_t bytes_transferred)
{
    if (ec) {
#ifdef PROXY_DEBUG
